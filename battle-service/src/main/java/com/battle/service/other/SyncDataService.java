...
public class SyncDataService {
	...
	final static Logger logger = LoggerFactory.getLogger(SyncDataService.class);
	
	public BattleRoom syncPaperData(BattlePeriodMember battlePeriodMember){
		...
		if(battlePeriodMember.getProcess()>=battlePeriodMember.getProcessGogal()){
